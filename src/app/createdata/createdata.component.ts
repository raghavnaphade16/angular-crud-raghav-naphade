...
import {validFirstChar,validLastChar} from '../shared/customvalidator.validator';
...
export class CreatedataComponent implements OnInit,OnDestroy {
  ...
  constructor(private apidata:APIInfoService,private http:HttpClient,private formBuilder: FormBuilder) {
